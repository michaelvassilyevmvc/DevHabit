...
public static class HabitMappings
{
    public static readonly SortMappingDefinition<HabitDto, Habit> SortMapping = new()
    {
        Mappings = [
            ...
            new SortMapping(nameof(HabitDto.UpdatedAtUtc),nameof(Habit.UpdateAtUtc)),
    ...
    public static HabitDto ToDto(this Habit habit)
    {
        return new HabitDto
        {
            ...
            UpdatedAtUtc = habit.UpdateAtUtc,
    ...
    public static void UpdateFromDto(this Habit habit, UpdateHabitDto dto)
    {
        ...
        {
            habit.Milestone ??= new Milestone(); // Create if doesn't exists
