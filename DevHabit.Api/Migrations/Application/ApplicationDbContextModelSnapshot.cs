...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Enities.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Enities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Enities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Api.Enities.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Api.Enities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Api.Enities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Api.Enities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DevHabit.Api.Enities.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Api.Enities.Habit", null)
                        .WithMany()
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("DevHabit.Api.Enities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
